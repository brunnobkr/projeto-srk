...
>>>>>>> 5861862c828c1525867791b9c0ff1bd2fc908de9
                  </p>
                )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center mb-4">
              <div>
                <h2 className="text-2xl font-bold text-gray-900">{viewingInstrucao.titulo}</h2>
                <p className="text-sm text-gray-600 mt-1">Código: {viewingInstrucao.codigoProduto}</p>
            ...
            <div className="space-y-6">
              <div className="flex space-x-2">
                <span className="px-3 py-1 text-sm rounded-full bg-primary-100 text-primary-800 font-medium">
                  {getTipoInstrucaoLabel(viewingInstrucao.tipoInstrucao || 'insercao')}
                </span>
                {viewingInstrucao.preparador && (
                  <span className="px-3 py-1 text-sm rounded-full bg-blue-100 text-blue-800">Preparador</span>
                )}
                {viewingInstrucao.funcionario && (
                  <span className="px-3 py-1 text-sm rounded-full bg-green-100 text-green-800">Funcionário</span>
                )}
              </div>
              ...
              <div className="border-t pt-6">
                ...
                <div className="space-y-4">
                  {viewingInstrucao.passos
                    ...
                    .map((passo) => (
                      <div key={passo.letra} className="bg-gray-50 p-4 rounded-lg">
                        <div className="flex items-center space-x-2 mb-2">
                          <span className="font-semibold text-gray-700">Passo {passo.letra}:</span>
                          <span className="px-2 py-1 text-xs rounded-full bg-primary-100 text-primary-800">
                            {getTipoLabel(passo.tipo)}
