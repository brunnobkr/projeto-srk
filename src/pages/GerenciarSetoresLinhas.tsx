...
export default function GerenciarSetoresLinhas() {
  ...
  const inicializarSetoresPadrao = () => {
    ...
    const setorPinturaPreReform: Setor = {
      ...
      nome: 'Pintura Pr├® Reformatura',
      descricao: 'Pintura Pr├® Reformatura',
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Chamados e Problemas T├®cnicos */}
      {(problemasTecnicos.length > 0 || chamadosManutencao.length > 0) && (
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center space-x-3 mb-4">
            <AlertTriangle className="w-6 h-6 text-orange-500" />
            <h2 className="text-xl font-bold text-gray-900">Chamados e Problemas T├®cnicos Pendentes</h2>
          </div>

          {/* Problemas T├®cnicos */}
          {problemasTecnicos.length > 0 && (
            <div className="mb-6">
              <h3 className="text-lg font-semibold text-gray-900 mb-3">Problemas T├®cnicos</h3>
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          <span className={`px-2 py-1 text-xs rounded-full ${
                            ...
                            {problema.tipo === 'mecanico' ? 'Mec├ónico' :
                             problema.tipo === 'eletrico' ? 'El├®trico' : 'Sistema'}
                          </span>
                          <span className={`px-2 py-1 text-xs rounded-full ${
                          ...
                          <span className="flex items-center">
                            ...
                            {(() => {
                              try {
                                ...
                                return `${format(data, 'dd/MM/yyyy', { locale: ptBR })} ├ás ${problema.hora || '-'}`;
                              } catch {
                      ...
                      <div className="flex-1">
                        <div className="flex items-center space-x-2 mb-2">
                          <span className={`px-2 py-1 text-xs rounded-full ${
                            ...
                            {chamado.tipo === 'mecanica' ? 'Mec├ónica' : 'El├®trica'}
                          </span>
                          <span className={`px-2 py-1 text-xs rounded-full ${
                          ...
                          <span className="flex items-center">
                            ...
                            {(() => {
                              try {
                                ...
                                return `${format(data, 'dd/MM/yyyy', { locale: ptBR })} ├ás ${chamado.horaSolicitacao || '-'}`;
                              } catch {
